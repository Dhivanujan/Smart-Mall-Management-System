...
export const ComplaintsPage = () => {
    ...
    if (loading)
        return <div className="loading-center"><div className="spinner"/><span className="spinner-text">Loading complaints…</span></div>;
    return (<div className="customer-page">
			...
			{showForm && (<div className="panel" style={{ marginBottom: "2rem" }}>
			...
			{complaints.length === 0 ? (<div className="empty-panel">
					...
					{complaints.map((c) => (<div key={c.id} className="complaint-item animate-fade-in-up">
							...
							{c.logs && c.logs.length > 0 && (<div className="complaint-logs">
									...
									{c.logs.map((log, i) => (<div key={i} className="complaint-log-entry">
