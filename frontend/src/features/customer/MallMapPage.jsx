...
export const MallMapPage = () => {
    ...
    if (loading)
        return <div className="loading-center"><div className="spinner"/><span className="spinner-text">Loading mall map…</span></div>;
    ...
    return (<div className="customer-page">
            ...
            return (<div key={zone} className="map-zone-label" style={{ left: `${avgX - 5}%`, top: `${avgY - 8}%` }}>
									{zone}
								</div>);
        })}
