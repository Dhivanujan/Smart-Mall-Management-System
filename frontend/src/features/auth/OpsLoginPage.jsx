...
export const OpsLoginPage = () => {
  ...
  const applyDemoCredentials = () => {
    setUsername("superadmin@example.com");
      ...
      <div className="hidden lg:flex flex-col justify-center px-12 xl:px-20 relative bg-secondary/20">
        ...
        <div className="max-w-md space-y-6 relative z-10">
          ...
          <div className="pt-4" role="group" aria-label="Demo accounts">
              ...
              >
                <div className="shrink-0 w-10 h-10 rounded-md bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center shadow-sm">
                ...
                <div className="text-left flex-1">
                  ...
                  <div className="text-xs text-muted-foreground">Load demo ops credentials</div>
                </div>
