...
export const QueueEfficiencyPage = () => {
    ...
    if (!data.length)
        return <p>No queue efficiency data available</p>;
    const effColor = (rate) => {
        if (rate >= 90)
    ...
    return (<div className="panel-page">
			...
			{data.length > 0 && (<div className="section-card">
					...
					<div className="data-table-wrapper">
						<table className="data-table">
							...
							<tbody>
								{data.map((store) => (<tr key={store.store_id}>
